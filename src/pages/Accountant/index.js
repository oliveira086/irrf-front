...
import { HomeAccountantStyle } from './style';
...
const HomeAccountant = () => {
  ...
  async function searchPayment () {
    ...
    if(cnpjSearch == '') {
      ...
      (async () => await getUserInformations({ currentPage: currentPage, enabled: enabled }).then(async response => {
  ...
  return (
    <section className={HomeAccountantStyle.Container}>
      <Header userName={userName} cityName={cityName} />
      <div className={HomeAccountantStyle.BodyContainer}>
        <div className={HomeAccountantStyle.TitleContainer}>
          <div>
          ...
          <div className='h-auto'>
            <div className='flex justify-between'>
              <div className='w-96 h-full'>
                ...
                <div className='flex flex-col w-full h-auto rounded bg-[#F2F5FF] p-2 mt-2'>
                  <span className='font-semibold'>CNPJ Ordenador</span>
...

        {
          ...
          <div className={HomeAccountantStyle.TableContainer}>
                    ...
                    return (
                      <>
                        <chakra.Tr>
                          ...
                          <chakra.Td><FiDownload size={28} className='cursor-pointer' onClick={() => {sessionStorage.setItem('payment_id', paymentsDataCallback.id); navigate('/extrato-fiscal')}} /></chakra.Td>
                        </chakra.Tr>
                      </>
                    )
                  })}
