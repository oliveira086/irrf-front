...
import { SupplierPaymentsStyle } from './style';
...
const SupplierPayments = () => {
  ...
  return (
    <section className={SupplierPaymentsStyle.Container}>
      <Header userName={userName} cityName={cityName} />
      <div className={SupplierPaymentsStyle.BodyContainer}>
        <div className={SupplierPaymentsStyle.TitleContainer}>
...

        {
          ...
          <div className={SupplierPaymentsStyle.TableContainer}>
