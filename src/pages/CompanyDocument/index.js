...
import { CompanyDocumentStyle } from './style';
...
const FiscalDocument = () => {
  ...
  const getInformations = async() => {
    ...
    let response = await getCompanyPayment({ payment_id: payment });
  ...
  return (
    <section className={CompanyDocumentStyle.Container}>
      <div className={CompanyDocumentStyle.BodyContainer}>
        <div className={CompanyDocumentStyle.PlayerContainer}>
          <Player
